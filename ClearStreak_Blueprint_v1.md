...
| 2026-08-20 | **No IP/legal gate on re-authored content** (864zeros decision) | Passages + affirmations are original 864zeros writing derived from citable PD sources (1939 Big Book via Dover PD reprint; KJV). Original authorship = 864zeros IP; ship without a pre-publish legal review. Reverses the earlier "counsel-gated / legal read owed" caution |
